# Задача Камень-ножницы-бумага-ящерица-спок
...
# Примечание. Правила игры стандартные: ножницы режут бумагу. Бумага заворачивает камень. Камень давит ящерицу, а ящерица травит Спока, в 
...
choise_Timur = input("Введите ваш выбор: ")
choise_Ruslan = input("Введите ваш выбор: ")
...
print(dictionary[f'{choise_Timur}-{choise_Ruslan}'])
