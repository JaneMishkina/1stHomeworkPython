# 3)Искусственный интеллект Антон, созданный Гилфойлом, взломал сеть умных холодильников. Теперь он использует их в качестве серверов 
...
# dict = "abcdefghijklmnopqrstuvwxyz0123456789" не используем, потому что очень маленькая верятность встретить слово anton
dict = "aanxnttoo45"
line_1 = []
target = 'anton'
